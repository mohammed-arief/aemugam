package com.aem.ugam.core.schedulers;

import com.aem.ugam.core.config.SchedulerConfiguration;
...
public class UgamSchedulerJobs implements Job {
    private static final Logger LOG = LoggerFactory.getLogger(UgamSchedulerJobs.class);
