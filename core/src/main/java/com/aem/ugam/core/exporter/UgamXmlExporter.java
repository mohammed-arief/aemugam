package com.aem.ugam.core.exporter;
...
public class UgamXmlExporter implements ModelExporter {
    private static final Logger LOG = LoggerFactory.getLogger(UgamXmlExporter.class);
