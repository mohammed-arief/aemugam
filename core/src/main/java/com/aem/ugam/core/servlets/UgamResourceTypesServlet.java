...
@SlingServletResourceTypes(
        ...
        resourceTypes = "aemugam/components/structure/page",
        selectors = {"ugam","test"},
        extensions = {"txt","xml"}
)
public class UgamResourceTypesServlet extends SlingAllMethodsServlet {

    private static final Logger LOG = LoggerFactory.getLogger(UgamResourceTypesServlet.class);
